...
import './index.css';
import Growwgram from './images/growwgram-logo.png';

function Header () {
  return (
    <div className="H201Container">
      <div className="H201LeftChild">
        <div className="H201LogoWrapper">
          <img src={Growwgram} alt='Growwgram' />
        </div>
        <div className="H201InputWrapper">
          <input className="H201Input" type='text' placeholder="Search" />
        </div>
      </div>
      <div className="H201RightChild">
      ...
      <div className="H201ProfileImageWrapper">
        <img className="H201ProfileImage" src="https://cdn.vox-cdn.com/thumbor/DFf_7DYeFj0LoGPEj5DOMf9tolg=/0x0:3926x3123/1820x1213/filters:focal(1649x1248:2277x1876):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/70305223/1234657391.0.jpg"  alt='content' />
      </div>
      </div>
    </div>
  )
